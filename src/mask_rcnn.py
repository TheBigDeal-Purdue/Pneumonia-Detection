...
os.system('git clone https://www.github.com/matterport/Mask_RCNN.git')
os.chdir('Mask_RCNN')
...
os.system('wget https://github.com/TheBigDeal-Purdue/Pneumonia-Detection/raw/master/src/myweight.h5')
COCO_WEIGHTS_PATH = "myweight.h5"
